...
@interface FlutterTencentplayerPlusPlugin ()
...
@implementation FlutterTencentplayerPlusPlugin
...
//    FlutterTencentplayerPlugin* instance = [[FlutterTencentplayerPlugin alloc] init];
   FlutterTencentplayerPlusPlugin* instance = [[FlutterTencentplayerPlusPlugin alloc] initWithRegistrar:registrar];
