package plus.tencentplayer.wilson.flutter.flutter_tencentplayer_plus;
 ...
 */
public class FlutterTencentplayerPlusPlugin implements MethodCallHandler {
...
//            mVodPlayer.enableHardwareDecode(true);
  ...
  private FlutterTencentplayerPlusPlugin(Registrar registrar) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    final FlutterTencentplayerPlusPlugin plugin = new FlutterTencentplayerPlusPlugin(registrar);
